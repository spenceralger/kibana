...
export class FatalErrorsService {
  public errorInfo$ = new Rx.ReplaySubject<ErrorInfo>(Infinity);
  public subscription?: Rx.Subscription;

  constructor(
    private rootDomElement: HTMLElement,
    private injectedVars: InjectedMetadataService,
    private stopCoreSystem: () => void
  ) {
  ...
  private onFirstError = () => {
    ...
    render(
      <FatalErrorsScreen
        buildNumber={this.injectedVars.getKibanaBuildNumber()}
        kibanaVersion={this.injectedVars.getKibanaVersion()}
