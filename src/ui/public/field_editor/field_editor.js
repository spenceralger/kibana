...
.directive('fieldEditor', function (Private, $sce) {
  ...
  const scriptingInfo = $sce.trustAsHtml(require('ui/field_editor/scripting_info.html'));
  const scriptingWarning = $sce.trustAsHtml(require('ui/field_editor/scripting_warning.html'));
